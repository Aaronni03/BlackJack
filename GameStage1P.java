...
/**
 * The gameStage1P class manages the GUI of a single player version of the Blackjack game.
 * The gameStage1P class is a subclass of AbstractGameStage.
 * The purpose of this class is to set up a game stage for a single player version of the Blackjack game.
 * The constructor creates an instance of the super class, which holds an instance of ArrayList of Player called playerList.
 * The gameStage1P class creates instances of a Deck object and a Player object using the deck. 
 * The Player object is added to the playerList.
 * 
 * @author Zhaoliang Ni
 */
public class GameStage1P extends AbstractGameStage {
