...
/**
 * The gameStage3P class manages the GUI of a three-player version of the Blackjack game.
 * The gameStage3P class is a subclass of AbstractGameStage.
 * The purpose of this class is to set up a game stage for a three-player version of the Blackjack game.
 * The constructor creates an instance of the super class, which holds an instance of ArrayList of Player called playerList.
 * The gameStage3P class creates instances of a Deck object deck and three Player objects, p1, p2, p3 using the deck. 
 * The Player objects are then added to the playerList.
 * 
 * @author Zhaoliang Ni
 */

public class GameStage3P extends AbstractGameStage {
    ...
    public GameStage3P(double bal){
        ...
        p3 = new Player(this, deck, "Player 3", bal);
        ...
        grid.add(p2.content, 1, 2);
        grid.add(p3.content, 2, 2);
